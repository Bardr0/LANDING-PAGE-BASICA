  ...
  return (
    <section className="mt-36">
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className=" p-10 sm:p-10 md:pd-15 lg:p-30 xl:p-36">
          <motion.img
            src={Logo}
            alt="Logo del juego"
          ...
          >
            ...
            fantasia donde te embarcas en una epica busqueda mágica. Explora
            reinos misterioso, domina poderosos hechizos y enfréntate a
        ...
        {/*Imagen*/}
        <motion.div className="p-10 sm:p-10 md:pd-15 lg:p-30 xl:p-36"
